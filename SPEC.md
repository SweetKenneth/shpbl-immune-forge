...
2. Data-driven baseline evidence must identify the sealed scenario. With baseline reproduction required (the
   default), the baseline must reproduce the relevant event **and report the attack succeeding** or the episode
   is INCONCLUSIVE.
